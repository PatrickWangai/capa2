...
export default function OrangeIcon({ className = '', size = 40 }: Props) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className={className} aria-label="Capa">
      ...
      {/* Specular highlight */}
      <ellipse cx="70" cy="70" rx="28" ry="19" fill="var(--muted-foreground)" transform="rotate(-35 70 70)" />
      <ellipse cx="62" cy="62" rx="10" ry="7"  fill="var(--muted-foreground)" transform="rotate(-35 62 62)" />
      ...
      <path d="M98,27 C115,15 136,18 143,29" stroke="var(--muted-foreground)" strokeWidth="2"   fill="none" strokeLinecap="round" />
