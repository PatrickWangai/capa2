...
export function MobileNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-30 flex items-center justify-around border-t-2 border-line-strong bg-paper pb-[env(safe-area-inset-bottom)] lg:hidden">
      {MOBILE_NAV.map((item) => {
